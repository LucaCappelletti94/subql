//! A [`crate::visibility::VisibilityPolicy`] that answers from the changed row where the
...
//! Where it does not, the question goes to another [`crate::visibility::VisibilityPolicy`] the
//! caller supplies.
//!
...
//! handed to an inner [`crate::visibility::VisibilityPolicy`], which a separate crate
...
//! [`crate::visibility::VisibilityPolicy::may_see`] takes every watcher at once, so a delegated
...
pub(crate) mod write_statement;

pub use request_values::RequestValues;
pub use row_policy::RowPolicy;
pub use subject::Subject;
pub(crate) use write_statement::{image_of, statement_of, table_of};
