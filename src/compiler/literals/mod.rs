...
///   `Boolean(true)` targeting [`crate::backend::BuiltinKind::Timestamp`]) the result is
...
///   [`crate::backend::BuiltinKind::Uuid`]) the result is [`RegisterError::TypeError`]
...
mod tests {
    ...
    use crate::backend::{BuiltinKind, MySql, Pg18, Postgres, SQLite, Value};
    use crate::RegisterError;
    use sqlparser::ast::Value as SqlValue;
