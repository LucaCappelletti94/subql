...
pub use scalar_value::{
    ...
    FloatOrder, FloatWidth, GroupKeyEncoder, IntWidth, MeanRule, NoCustom, NoCustomScalars,
    NumericWidening, ScalarKind, ScalarKindOf, SumRule, TextCase, TextOperation, TextRule,
    TextWidth, TrailingSpacePadding, TrailingSpaces, Value, ValueKind, ValueKindOf, VarianceSeed,
};
