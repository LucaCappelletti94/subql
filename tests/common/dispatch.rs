...
use sqlite_diff_rs::{
    Adapter, Binder, DefaultBinder, DiffOps, Insert, ParsedDiffSet, PatchDelete, PatchSet,
    PatchsetFormat, PatchsetOp, SimpleTable, Update, Value,
};
...
fn rebuild(bytes: &[u8], table: &SimpleTable) -> PatchSet<SimpleTable, String, Vec<u8>> {
