...
use subql::{
    DefaultIds, MaxwellEvent, MaxwellParser, SubscriptionEngine, SubscriptionRequest,
    Wal2JsonV2Event, Wal2JsonV2Parser, WalParser,
};
...
fn dispatch_events<P>(
    engine: &mut SubscriptionEngine<P::Event, DefaultIds, ParserDB>,
    parser: &P,
    messages: &[String],
    catalog: &ParserDB,
) -> Vec<BTreeSet<u64>>
